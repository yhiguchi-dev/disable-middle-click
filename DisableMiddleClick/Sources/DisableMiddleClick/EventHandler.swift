...
public class EventHandler {
    ...
    func handleAndDisableMiddleClick(callback: () -> Void) -> Void {
        let eventMask = CGEventMask((1 << CGEventType.otherMouseUp.rawValue) | (1 << CGEventType.otherMouseDown.rawValue))
